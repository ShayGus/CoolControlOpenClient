...
class CreateUserRequestBody(object):
    ...
    def __init__(self, username=None, password=None, temperature_scale=None, permissions=None, first_name=None, last_name=None, email=None, phone=None, _configuration=None):  # noqa: E501
    ...
    def temperature_scale(self, temperature_scale):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and temperature_scale is None:
