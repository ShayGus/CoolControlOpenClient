...
class UpdateUnitRequestBody(object):
    ...
    def __init__(self, name=None, type=None, supported_switch_modes=None, supported_modes=None, supported_fan_modes=None, supported_swing_modes=None, temperature_limits=None, _configuration=None):  # noqa: E501
