...
class DeviceApi(object):
    ...
    def devices_device_id_put(self, x_access_token, body, device_id, **kwargs):  # noqa: E501
        """update device  # noqa: E501

        update device  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.devices_device_id_put(x_access_token, body, device_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.devices_device_id_put_with_http_info(x_access_token, body, device_id, **kwargs)  # noqa: E501
        else:
            (data) = self.devices_device_id_put_with_http_info(x_access_token, body, device_id, **kwargs)  # noqa: E501
            return data

    def devices_device_id_put_with_http_info(self, x_access_token, body, device_id, **kwargs):  # noqa: E501
        """update device  # noqa: E501

        update device  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.devices_device_id_put_with_http_info(x_access_token, body, device_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['x_access_token', 'body', 'device_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
