...
class SitesApi(object):
    ...
    def sites_get(self, x_access_token, site_id, **kwargs):  # noqa: E501
        """get my sites  # noqa: E501

        get my sites  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sites_get(x_access_token, site_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.sites_get_with_http_info(x_access_token, site_id, **kwargs)  # noqa: E501
        else:
            (data) = self.sites_get_with_http_info(x_access_token, site_id, **kwargs)  # noqa: E501
            return data

    def sites_get_with_http_info(self, x_access_token, site_id, **kwargs):  # noqa: E501
        """get my sites  # noqa: E501

        get my sites  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sites_get_with_http_info(x_access_token, site_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('site_id' not in params or
            ...
            raise ValueError("Missing the required parameter `site_id` when calling `sites_get`")  # noqa: E501
