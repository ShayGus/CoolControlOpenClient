...
class TestControlTreeResponseDataCustomers(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ControlTreeResponseDataCustomers:
        """Test ControlTreeResponseDataCustomers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlTreeResponseDataCustomers`
        """
        model = ControlTreeResponseDataCustomers()
        if include_optional:
            return ControlTreeResponseDataCustomers(
