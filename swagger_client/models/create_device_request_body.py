...
class CreateDeviceRequestBody(object):
    ...
    def __init__(self, name=None, serial=None, pin=None, _configuration=None):  # noqa: E501
    ...
    def serial(self, serial):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and serial is None:
    ...
    def pin(self, pin):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and pin is None:
