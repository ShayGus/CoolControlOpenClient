...
class UpdateUserRequestBody(object):
    ...
    def __init__(self, username=None, temperature_scale=None, permissions=None, first_name=None, last_name=None, email=None, phone=None, _configuration=None):  # noqa: E501
