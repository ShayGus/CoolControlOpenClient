...
class SiteResponseData(object):
    ...
    def __init__(self, id=None, name=None, description=None, country=None, city=None, postal_code=None, address=None, timezone=None, customer=None, devices=None, zones=None, systems=None, role=None, _configuration=None):  # noqa: E501
