...
class UnitControlSwitchesBody(object):
    ...
    @property
    def mode(self):
        """Gets the mode of this UnitControlSwitchesBody.  # noqa: E501

        requested operation status from the operation status enumeration  # noqa: E501

        :return: The mode of this UnitControlSwitchesBody.  # noqa: E501
        :rtype: int
        """
        return self._mode
    ...
    @mode.setter
    def mode(self, mode):
        """Sets the mode of this UnitControlSwitchesBody.

        requested operation status from the operation status enumeration  # noqa: E501

        :param mode: The mode of this UnitControlSwitchesBody.  # noqa: E501
        :type: int
        """
