...
class SiteSystemsApi(object):
    ...
    def sites_site_id_systems_post(self, x_access_token, body, site_id, **kwargs):  # noqa: E501
        """create site system  # noqa: E501

        create site system  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sites_site_id_systems_post(x_access_token, body, site_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.sites_site_id_systems_post_with_http_info(x_access_token, body, site_id, **kwargs)  # noqa: E501
        else:
            (data) = self.sites_site_id_systems_post_with_http_info(x_access_token, body, site_id, **kwargs)  # noqa: E501
            return data

    def sites_site_id_systems_post_with_http_info(self, x_access_token, body, site_id, **kwargs):  # noqa: E501
        """create site system  # noqa: E501

        create site system  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sites_site_id_systems_post_with_http_info(x_access_token, body, site_id, async_req=True)
        >>> result = thread.get()
